...
mkdir build && cd build
# You need to replace the paths to the libssh build and include folder, and choose Debug or Release. p.e.:
cmake -DLIBSSH_CONFIG_PATH=/home/foca/shared/libssh-0.8.7/build/ -DLIBSSH_INCLUDE_PATH=/home/foca/shared/libssh-0.8.7/include/ -DCMAKE_BUILD_TYPE=Debug .. && make
```
